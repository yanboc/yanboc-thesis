\begin{figure}[htbp]
    ...
    \begin{tikzpicture}[scale=1.5]
      ...
      \node (FLT_ref) at (FLT.south) [below] {\cite{AL2021Feature}};
  
      % Caption
      \coordinate (caption1) at ($(A)+(-6.5,2)$);
      \node at (caption1) [right] {均值场理论（MF）: \cite{AL2021Feature}};
      \coordinate (caption2) at ([yshift=-12pt]caption1);
      \node at (caption2) [right] {梯度流（GF）: \cite{AL2021Feature}};
      \coordinate (caption3) at ([yshift=-12pt]caption2);
      \node at (caption3) [right] {神经正切核（NTK）: \cite{AL2021Feature}};
      \coordinate (caption4) at ([yshift=-12pt]caption3);
      \node at (caption4) [right] {概率近似正确（PAC）: \cite{AL2021Feature}};
      \coordinate (caption5) at ([yshift=-12pt]caption4);
      \node at (caption5) [right] {可表示性理论（EA）: \cite{AL2021Feature}};
      \coordinate (caption6) at ([yshift=-12pt]caption5);
      \node at (caption6) [right] {VC 维理论（VCD）: \cite{AL2021Feature}};
      \coordinate (caption7) at ([yshift=-12pt]caption6);
      \node at (caption7) [right] {样本复杂度（SC）: \cite{AL2021Feature}};
  \end{tikzpicture}
  \caption{学习理论分类图。}
