...
% 句首引用用 \Cref；与 \crefname 一致以便 subsection 等正确解析
\Crefname{chapter}{章}{章}
\Crefname{section}{节}{节}
\Crefname{subsection}{小节}{小节}
...
\crefmultiformat{subsection}{#2第#1小节#3}{和#2第#1小节#3}{，#2第#1小节#3}{和#2第#1小节#3}
...
\crefrangemultiformat{subsection}{#3第#1小节#4至#5第#2小节#6}{和#3第#1小节#4至#5第#2小节#6}{，#3第#1小节#4至#5第#2小节#6}{和#3第#1小节#4至#5第#2小节#6}
